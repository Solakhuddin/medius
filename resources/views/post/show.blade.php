        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <section class="space-y-6 px-4 py-8" id="comment-section">
                    ...
                    <div x-data="{
                        // State utama
                        comments: {{ $post->comments->load('replies.user')->toJson() }}, // Muat juga balasan dan user dari balasan
                        newComment: '',
                        postSlug: '{{ $post->slug }}',
                        replyingTo: null, // ID komentar yang sedang dibalas
                        submitInProgress: false,

                        // State baru untuk Edit
                        editingComment: null, // Menyimpan objek comment yang sedang diedit
                        ...
                        startEditing(comment) {
                            ...
                            this.replyingTo = null; // Tutup form balasan jika ada
                        },
                        cancelEditing(comment) {
                            comment.body = comment.originalBody; // Kembalikan teks asli
                        ...
                        submitComment(body, parentId = null) {
                            fetch(`/posts/${this.postSlug}/comments`, {
                                method: 'POST',
                                headers: {
                                ...
                                <div class="flex space-x-3">
                                    ...
                                    <div class="flex-1 space-y-2">
                                        ...
                                        <div>
                                            ...
                                            {{-- Opsi: Balas, Edit, Hapus untuk KOMENTAR INDUK --}}
                                                    ...
                                                    <div class="flex-1">
                                                        ...
                                                        <div x-show="editingComment?.id !== reply.id">
                                                            ...
                                                            <div class="flex items-center gap-x-4 mt-2 text-sm">
                                                                ...
                                                                @endauth
                                                                @if(auth()->check())
                                                                    {{-- Gunakan 'reply.user_id' untuk otorisasi --}}
                                                                    <template x-if="reply.user_id === {{ auth()->id() }}">
                                                                        <span>
                                                                            
                                                                            {{-- Gunakan 'reply' sebagai argumen --}}
                                                                            <button @click="startEditing(reply)" class="font-semibold text-gray-600">Edit</button>
                                                                            {{-- Kirim 'reply.id' dan 'comment.id' sebagai parentId --}}
                                                        ...
                                                        {{-- Form Edit untuk BALASAN (Ini bagian baru yang penting) --}}
